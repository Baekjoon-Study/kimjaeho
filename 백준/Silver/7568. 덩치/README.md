...
## REVIEW
for문을 두 번 쓰면 시간초과 난다는 강박관념이 있어서 안쓰려고 발악을 했다.
근데 짜고 나니 말도 안되는 알고리즘이 완성되어 있더라...
결국 답보고 쓰는데 for문 두 개로 해도 되는 거였다. 음.
시간복잡도는 O(n^2)나오는데... 시간초과 기준을 잘 모르겠다.
